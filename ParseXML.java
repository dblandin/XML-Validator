...
public class ParseXML
{
        ...
        try
        {
            ...
            while ( line != null )
            {
                ...
                for (int i = 0; i < lineTokens.length; i++)
                {
                    ...
                    // if token is an closing tag, check if it matches the first opening tag in stack
                    if (token.getType() == 2)
                    {
                        ...
                        if (!XMLTokenStack.isEmpty() && XMLTokenStack.peek().getToken().equals(close)) 
                        {
                            ...
                            // if indentation is greater thatn 0, pull back the indentation
                            if (indentation > 0)
                            {
                                XMLTokenStack.pop();
                                indentation--;
    ...
    private class XMLToken
    {
        ...
        public int getIndentation() { return this.indentation; }
